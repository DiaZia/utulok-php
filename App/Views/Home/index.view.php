            ...
            <div id="carouselExampleCaptions" class="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="public/images/pets1.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Adoptuj si najlepšieho kamaráta</h5>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="public/images/pets2.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Zachráň život nevinnému zvieratku</h5>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="public/images/pets3.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
